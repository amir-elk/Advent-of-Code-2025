-- All of the following code is taken from ratherforky's AoC (see README)
...
parseInput parser = parseMaybe parser .> fromJust -- === fromJust . parseMaybe parser

-- run parser on every line
